---
title: Kapcsolat - Simeza Art
description: Küldjön üzenetet a Simeza Art csapatának.
keywords: simeza, kapcsolat, pavy beloyu, elucian moise
...
<div class="contact-page-overlay">
  <section class="contact-page-dialog" role="dialog" aria-modal="true" aria-labelledby="contactTitle">
    <button type="button" class="contact-page-close" id="closeContactBtn" aria-label="Bezárás">&times;</button>
    <h1 id="contactTitle">Kapcsolat</h1>
    ...
    <form id="contactForm">
      ...
      <div class="contact-field">
        <label for="contactSubject">Tárgy</label>
        <input id="contactSubject" name="subject" type="text" value="Simeza kapcsolatfelvételi üzenet" required>
      </div>
      ...
      <div class="contact-page-actions">
        <button type="button" id="closeContactAction" class="contact-close-action">Bezárás</button>
        <button type="button" id="newContactBtn" class="contact-new-action">Új</button>
        <button type="submit" class="contact-send-action"><i class="bi bi-envelope" aria-hidden="true"></i><span>Küldés</span></button>
      </div>
    </form>
  </section>
</div>