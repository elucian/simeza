...
description: Envoyez un message à l'équipe de Simeza Art.
...
<div class="contact-page-overlay">
  <section class="contact-page-dialog" role="dialog" aria-modal="true" aria-labelledby="contactTitle">
    <button type="button" class="contact-page-close" id="closeContactBtn" aria-label="Fermer">&times;</button>
    ...
    <form id="contactForm">
      ...
      <div class="contact-field">
        ...
        <input id="contactSubject" name="subject" type="text" value="Message de contact Simeza" required>
      </div>
      ...
      <div class="contact-page-actions">
        <button type="button" id="closeContactAction" class="contact-close-action">Fermer</button>
        <button type="button" id="newContactBtn" class="contact-new-action">Nouveau</button>
        <button type="submit" class="contact-send-action"><i class="bi bi-envelope" aria-hidden="true"></i><span>Envoyer</span></button>
      </div>
    </form>
  </section>
</div>